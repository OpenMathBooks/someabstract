...
\definecolor{front}{HTML}{DBA639}
\definecolor{bg}{HTML}{252D49}
...
\vfill
\color{ltxt}
{ \large\scshape Grassl $\cdot$ Mingus}\hfill {\scshape \LARGE Some Abstract Algebra} \hfill {\large \scshape Summer 2018 \qquad $\mathbb{O}$ $\mathbb{M}$ $\mathbb{B}$}
